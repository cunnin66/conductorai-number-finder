...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("How should we handle numbers with commas like 1,000,000?", [1000000], id="comma_separated"),
        pytest.param("How should we handle numbers as part of words or names like A4?", [4], id="numbers_in_name"),
    ],
)
